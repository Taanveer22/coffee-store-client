...
const Card = ({ item, stateCoffees, setStateCoffees }) => {
        ...
        fetch(`${import.meta.env.VITE_API_URL}/${id}`, {
          ...
          .then((data) => {
            ...
            if (data.deletedCount > 0) {
              ...
              const remainStateCoffees = stateCoffees.filter(
                (element) => element._id !== id,
              );
              setStateCoffees(remainStateCoffees);
            }
          });
      }
    });
  ...
  return (
    <div>
      <div className="max-w-3xl bg-gray-300 rounded-xl p-6 flex items-center gap-6">
        {/* Left: Image */}
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            onClick={() => handleDeleteCoffee(item._id)}
